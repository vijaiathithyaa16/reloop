...
export const INITIAL_REWARD_TRANSACTIONS: RewardCreditTransaction[] = [
  ...
  // Collector wallet earnings (Rajesh Kumar, usr_collector_01)
  {
    id: 'RC-901',
    type: 'earned',
    points: 2450,
    amountINR: 2450,
    productName: 'Material Sales Value — Batch CB-00071 & CB-00072',
    productCategory: 'Bonus',
    pickupRequestId: 'PR-1024',
    date: '2026-03-09T18:10:00Z',
    status: 'credited',
    notes: 'Downstream recycler settlement for verified collected weight',
    actorId: 'usr_collector_01',
  },
  {
    id: 'RC-902',
    type: 'earned',
    points: 320,
    amountINR: 320,
    productName: 'Collection Handover Reward',
    productCategory: 'Bonus',
    pickupRequestId: 'PR-1025',
    date: '2026-03-09T16:05:00Z',
    status: 'credited',
    notes: 'Successful doorstep handover confirmed by citizen',
    actorId: 'usr_collector_01',
  },
  {
    id: 'RC-903',
    ...
    points: 80,
    amountINR: 80,
    productName: 'Digital Scale Accuracy Bonus',
    productCategory: 'Bonus',
    pickupRequestId: 'PR-1024',
    date: '2026-03-08T11:20:00Z',
    status: 'credited',
    notes: 'Declared weight matched aggregator scale within 4% variance',
    actorId: 'usr_collector_01',
  },
  {
    id: 'RC-904',
    ...
    points: 150,
    amountINR: 150,
    productName: 'Downstream Hub Bonus',
    productCategory: 'Bonus',
    pickupRequestId: 'PR-1024',
    date: '2026-03-08T15:45:00Z',
    status: 'credited',
    notes: 'Delivered to recommended high-trust recycler partner',
    actorId: 'usr_collector_01',
  },
];
