...
export default function App() {
  ...
  const renderCurrentView = () => {
    ...
    if (currentPath === '/dashboard/aggregator') {
      return (
        <RBACGuard currentUser={currentUser} requiredRole="aggregator" onNavigate={navigate}>
          <AggregatorDashboard currentUser={currentUser!} />
        </RBACGuard>
      );
    }
