...
export const DEFAULT_ACCOUNTS: User[] = [
  ...
  {
    id: 'usr_aggregator_01',
    name: 'Bangalore E-Waste Aggregator Hub',
    email: 'aggregator@demo.com',
    role: 'aggregator',
    phone: '+91 98765 11223',
    organization: 'Karnataka Waste Aggregators Ltd. (CPCB Lic: AGG-2026-09)',
